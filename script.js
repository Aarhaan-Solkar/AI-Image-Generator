...
const OPENAI_API_KEY = "sk-proj-7FQ7nJLMAvcLyFVT3w07T3BlbkFJo0tWgIhiSbLZDlf9Is50"; // Your OpenAI API key here
...
const handleImageGeneration = (e) => {
  ...
  const imgCardMarkup = Array.from({ length: userImgQuantity }, () => 
      `<div class="img-card loading">
        <img src="circle-arrow-icon.svg" alt="AI generated image">
        <a class="download-btn" href="#">
          <img src="download-image-icon.svg" alt="download icon">
        </a>
      </div>`
  ).join("");
